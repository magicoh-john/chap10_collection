...
public class ProductMain {
	...
	private static void printProductMap2(Map<Integer, Product> productMap) {
		...
		while(iter.hasNext()) {
			...
			System.out.println(productMap.get(key).getId() + "\t" + productMap.get(key).getName() + "\t" + productMap.get(key).getPrice());
		}
	...
	private static void printProductMap(Map<Integer, Product> productMap) {
		for (Integer key : productMap.keySet()) {
			System.out.println("key : " + productMap.get(key).getId() + "\t" + productMap.get(key).getName() + "\t" + productMap.get(key).getPrice());
		}		
	}
